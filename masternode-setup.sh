...
echo "*                                                                          *"
echo "*                         Dash Green Masternode Setup                      *"
echo "*                                                                          *"
echo "* This script will install and configure your Dash Green masternodes       *"
echo "****************************************************************************"
echo && echo && echo
echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
echo "!                                                 !"
...
chmod +x dashgreen*
sudo mv  dashgreend /usr/bin
sudo mv  dashgreen-cli /usr/bin
